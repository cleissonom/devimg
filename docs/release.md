...
```bash
curl -fsSLO https://github.com/cleissonom/devimg/releases/download/v0.1.0/devimg-linux-x86_64.tar.gz
curl -fsSLO https://github.com/cleissonom/devimg/releases/download/v0.1.0/devimg-linux-x86_64.tar.gz.sha256
...
```bash
cargo install --git https://github.com/cleissonom/devimg --tag v0.1.0 devimg-cli
```
